...
i = (i-1)*10;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  Plot
plot(i,NBOratio_i,'r-*',i,BOratio_i,'k-*',i,FOratio_i,'b-*',i,NBOratio_rand,'--or',i,BOratio_rand,'--ok',i,FOratio_rand,'--ob','LineWidth',1.5);
axis([0 80 0 1]);
title('Random Model Plot','fontsize',18,'fontweight','bold');
