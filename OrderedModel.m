...
switch(i_c) %Select Different Tg
    ...
    case 7
        ...
        Tg = 1450.4 ;
    case 8
        %D_E = 0.1; %%Test D_E Can I do this?
        Tg = 1492.4 ;
    case 9
       %D_E = 0.1;
       Tg = 1501.1 ;
...
i = 1:1:9;
i = (i-1)*10;
plot(i,NBOratio_rand,'-.or',i,BOratio_rand,'-.ok',i,FOratio_rand,'-.ob',i,NBOratio_i,'-*r',i,BOratio_i,'-*k',i,FOratio_i,'-*b',... 
    'LineWidth',2,...
    'MarkerSize',5,...
    'MarkerFaceColor',[0.5,0.5,0.5]);
axis([0 80 0 1]);
title('Ordered Model Plot','fontsize',16,'fontweight','bold');
