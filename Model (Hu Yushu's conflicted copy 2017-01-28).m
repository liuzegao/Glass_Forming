...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% First Scheme Plot
figure(1)
plot(i,NBOratio_i,'r-*',i,BOratio_i,'k-*',i,FOratio_i,'b-*',i,NBO_ratio_1,'--or',i,BO_ratio_1,'--ok','LineWidth',1.5);
axis([0 80 0 1]);
title('First Scheme Comparison','fontsize',18,'fontweight','bold');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Second Scheme Plot
figure(2)
plot(i,NBOratio_i,'r-*',i,BOratio_i,'k-*',i,FOratio_i,'b-*',i,NBO_ratio_2,'--or',i,BO_ratio_2,'--ok',i,FO_ratio_2,'--ob','LineWidth',1.5);
axis([0 80 0 1]);
title('Sescond Scheme Comparison','fontsize',18,'fontweight','bold');
xlabel('x(Ca %)','fontsize',16);
ylabel('OxygenType/Numer of O','fontsize',16 );
